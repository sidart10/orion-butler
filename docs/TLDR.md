...
This gets encoded into **1024-dimensional embeddings** via `BGE-M3`, so semantic search finds `verify_access_token()` even when you ask about JWT validation.
...
3. **Encode with BGE-M3** → 1024-dimensional vector
