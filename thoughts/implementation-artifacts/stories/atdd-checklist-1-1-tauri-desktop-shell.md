...
- [ ] **Test 1.1.1: App launches successfully from icon**
...
- [ ] **Test 1.1.2: App launches within NFR-P003 threshold (< 3 seconds)**
...
- [ ] **Test 1.1.3: Window has correct minimum dimensions**
...
- [ ] **Test 1.1.6: Window respects minimum size on resize attempt**
...
- [ ] **Test 1.1.8: Launch failure produces meaningful error log**
...
- [ ] **Test 1.2.1: App quits cleanly with exit code 0**
...
- [ ] **Test 1.2.2: No orphan processes after quit**
...
- [ ] **Test 1.2.3: Multiple close attempts are idempotent**
  - **Given:** Orion app is running
...
- [ ] **Test 1.2.5: Close during startup is handled**
...
- [ ] **Test 1.2.6: Shutdown logs are written without errors**
  - **Given:** Orion app is running
  - **When:** App is closed
...
- [ ] **Test 1.2.7: Shutdown completes even if frontend has errors**
...
- [ ] **Test 1.U.1: tauri.conf.json has correct window dimensions**
...
- [ ] **Test 1.U.4: Icon files exist at required paths**
...
|---------|-----|-------------|-----|--------|
| 1.1.1 | AC1 | App launches | - | Pending |
| 1.1.2 | AC1 | Launch < 3s | NFR-P003 | Pending |
| 1.1.3 | AC1 | Min dimensions | - | Pending |
| 1.1.4 | AC1 | macOS 12 compat | - | Pending |
| 1.1.5 | AC1 | macOS 13+ compat | - | Pending |
| 1.1.6 | AC1 | Min size enforce | - | Pending |
| 1.1.7 | AC1 | Dock icon | - | Pending |
| 1.1.8 | AC1 | Launch error log | - | Pending |
| 1.1.9 | AC1 | Frontend fallback | - | Pending |
| 1.2.1 | AC2 | Exit code 0 | - | Pending |
| 1.2.2 | AC2 | No orphans | - | Pending |
| 1.2.3 | AC2 | Idempotent close | - | Pending |
| 1.2.4 | AC2 | Force quit | - | Pending |
| 1.2.5 | AC2 | Close during startup | - | Pending |
| 1.2.6 | AC2 | Shutdown logs | - | Pending |
| 1.2.7 | AC2 | Frontend errors | - | Pending |
...
**Next Step:** Implement test files, then implement story code
