...
- [ ] **Task 1: Create Layout Shell Component** (AC: 1, 2)
  - [ ] 1.1 Create `src/components/layout/AppLayout.tsx`:
    ```typescript
    ...
    ```
  - [ ] 1.2 Implement fixed dimensions from design system
  - [ ] 1.3 Add overflow handling for nested scrolling

- [ ] **Task 2: Create Split Panel Container** (AC: 1, 8)
  - [ ] 2.1 Create `src/components/layout/SplitPanel.tsx`:
    ```typescript
    ...
    ```
  - [ ] 2.2 Implement 35/65 split ratio
  - [ ] 2.3 Add framer-motion animations with design system easing
  - [ ] 2.4 Include divider button for toggle

- [ ] **Task 3: Create Header Component** (AC: 1, 2)
  - [ ] 3.1 Create `src/components/layout/Header.tsx`:
    ...
    ```
  - [ ] 3.2 Implement logo with Orion branding
  - [ ] 3.3 Add search input with editorial styling
  - [ ] 3.4 Include notification and settings icons

- [ ] **Task 4: Create Sidebar Component** (AC: 1, 2, 7)
  - [ ] 4.1 Create `src/components/layout/Sidebar.tsx`:
    ```typescript
    ...
    ```
  - [ ] 4.2 Implement navigation items with icons
  - [ ] 4.3 Add collapse/expand behavior
  - [ ] 4.4 Handle responsive collapse at 800px

- [ ] **Task 5: Create Agent Rail Component** (AC: 1, 2)
  - [ ] 5.1 Create `src/components/layout/AgentRail.tsx`:
    ```typescript
    ...
    ```
  - [ ] 5.2 Add gold sparkle indicator for active agent
  - [ ] 5.3 Include new chat button
  - [ ] 5.4 Show recent chats as collapsed indicators

- [ ] **Task 6: Create Canvas Placeholder** (AC: 3)
  - [ ] 6.1 Create `src/components/canvas/CanvasPlaceholder.tsx`:
    ```typescript
    ...
    ```
  - [ ] 6.2 Use Playfair Display italic for headline
  - [ ] 6.3 Add gold accent decoration
  - [ ] 6.4 Include helpful hint text

- [ ] **Task 7: Create useMediaQuery Hook** (AC: 6, 7)
  - [ ] 7.1 Create `src/hooks/useMediaQuery.ts`:
    ```typescript
    ...
    ```
  - [ ] 7.2 Implement SSR-safe media query detection
  - [ ] 7.3 Support dynamic breakpoint changes

- [ ] **Task 8: Create useCanvasState Hook** (AC: 4, 5, 9)
  - [ ] 8.1 Create `src/hooks/useCanvasState.ts`:
    ```typescript
    ...
    ```
  - [ ] 8.2 Implement zustand store with persistence
  - [ ] 8.3 Add width constraints (25-75%)
  - [ ] 8.4 Track content type for mode switching

- [ ] **Task 9: Implement Keyboard Shortcuts** (AC: 9)
  - [ ] 9.1 Create `src/hooks/useLayoutShortcuts.ts`:
    ```typescript
    ...
    ```
  - [ ] 9.2 Implement Cmd+\ toggle shortcut
  - [ ] 9.3 Implement Esc to close canvas
  - [ ] 9.4 Register shortcuts in layout component

- [ ] **Task 10: Update Tailwind Config with Layout Tokens** (AC: 2)
  - [ ] 10.1 Verify/add layout tokens in `tailwind.config.ts`:
    ```typescript
    ...
    ```
  - [ ] 10.2 Add width tokens for sidebar, rail
  - [ ] 10.3 Add height token for header
  - [ ] 10.4 Add custom easing function

- [ ] **Task 11: Create Main Page Integration** (AC: 1)
  - [ ] 11.1 Update `src/app/page.tsx`:
    ```typescript
    // src/app/page.tsx
    ...
    ```
  - [ ] 11.2 Integrate layout components
  - [ ] 11.3 Connect chat and canvas containers

- [ ] **Task 12: Create Canvas Container** (AC: 3, 4, 5)
  - [ ] 12.1 Create `src/components/canvas/CanvasContainer.tsx`:
    ```typescript
    ...
    ```
  - [ ] 12.2 Implement mode switching logic
  - [ ] 12.3 Default to placeholder when empty

- [ ] **Task 13: Responsive Breakpoint Handling** (AC: 6, 7)
  - [ ] 13.1 Create `src/components/layout/ResponsiveLayout.tsx`:
    ```typescript
    ...
    ```
  - [ ] 13.2 Auto-collapse canvas at 1000px
  - [ ] 13.3 Collapse sidebar to icons at 800px
  - [ ] 13.4 Ensure no layout overflow

- [ ] **Task 14: Visual Regression Tests Setup** (AC: 8)
  - [ ] 14.1 Create `tests/e2e/layout.spec.ts`:
    ```typescript
    ...
    ```
  - [ ] 14.2 Test layout at various breakpoints
  - [ ] 14.3 Test panel proportion accuracy
  - [ ] 14.4 Test collapse/expand behavior

- [ ] **Task 15: Unit Tests for Layout Components** (AC: 1, 8)
  - [ ] 15.1 Create `tests/unit/components/layout/SplitPanel.test.tsx`:
    ```typescript
    ...
    ```
  - [ ] 15.2 Test panel rendering
  - [ ] 15.3 Test toggle behavior
  - [ ] 15.4 Test default props

- [ ] **Task 16: Add Framer Motion Dependency** (AC: 4, 5)
  - [ ] 16.1 Install framer-motion:
    ```bash
    pnpm add framer-motion
    ```
  - [ ] 16.2 Verify compatibility with Next.js 14
...
| E2E | Playwright | `tests/e2e/layout.spec.ts` | Visual regression |
