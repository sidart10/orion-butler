...
flowchart TD
    ...
    subgraph ContextInjection["CONTEXT INJECTION (Automatic)"]
        ...
        Memory["Semantic Memory<br/>(pgvector recall)"]
    ...
    subgraph AgentRouting["AGENT ROUTING"]
        ...
        subgraph CoreAgents["ORION CORE AGENTS (4)"]
    ...
    subgraph ToolExecution["TOOL EXECUTION"]
        ...
        subgraph Composio["Composio MCP"]
            Gmail["GMAIL_*"]
            Calendar["GOOGLECALENDAR_*"]
            Slack["SLACK_*"]
        end

        subgraph Approval["canUseTool Callback"]
    ...
    ContextInjection --> Butler

    Butler --> CoreAgents
    Butler --> AdaptedAgents

    CoreAgents --> ToolExecution
    AdaptedAgents --> ToolExecution

    ToolExecution --> Approval
    Approval --> Output

    Output --> Learning
    Learning -.->|"Store patterns"| Memory
```
